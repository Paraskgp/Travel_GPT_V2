...
- **[RESOLVED 2026-05-29]** Chunked dedup implemented for large cities. Pre-dedup candidates above 200 are split into batches, deduplicated in parallel, then merged in a final LLM pass. Silent crash for Tokyo (1087 candidates → 400+ pre-dedup) is now fixed.
